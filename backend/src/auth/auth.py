...
AUTH0_DOMAIN = 'fsndudacity.eu.auth0.com'
ALGORITHMS = ['RS256']
API_AUDIENCE = 'fsnd-beverages'
...
def check_permissions(permission, payload):
    print("here is the payload", payload['permissions'])
    if 'permissions' not in payload:
        print("says not in payload", payload['permissions'])
        raise AuthError({
            'code': 'invalid_claims',
